<x-app>
	<form method="POST" action="{{ route('profile', ['user' => $user]) }}" enctype="multipart/form-data">
		@csrf
		@method('PATCH')
		...
		<div class="mb-6">
			...
			<input class="border border-gray-400 p-2 w-full" type="text" name="email" id="email" value="{{ $user->email }}" required>
